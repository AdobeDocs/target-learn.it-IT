...
+ [Panoramica](https://experienceleague.adobe.com/docs/target-learn/tutorials/overview.html?lang=it)
+ [Scaricare e aggiornare l’app di esempio](download-and-update-the-sample-app.md)
+ [Aggiungi richieste](add-requests.md)
+ [Aggiungi parametri](add-parameters.md)
+ [Creare tipi di pubblico e offerte](create-audiences-and-offers.md)
+ [Personalizzazione dei layout](personalize-layouts.md)
+ [Contrassegno di funzione](feature-flagging.md)
